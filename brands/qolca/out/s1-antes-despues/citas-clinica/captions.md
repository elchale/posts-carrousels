...
```text
Cómo una clínica pasó de 30% a 9% de citas perdidas 🏥
#clinicas #automatizacion #salud
```
...
```text
Caso de clínica: reducción de citas perdidas del 30% al 9% con recordatorios conversacionales y lista de espera.
```
