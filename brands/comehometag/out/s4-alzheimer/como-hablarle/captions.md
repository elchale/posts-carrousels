...
```text
Frases que calman a un abuelito desorientado (y la que duele) 💜
...
```text
Frases para calmar a un adulto mayor desorientado por Alzheimer y la pulsera ComeHomeTag.
```
...
```text
"¿Sabes quién soy?" es un examen que duele dos veces. Los especialistas recomiendan regalar la respuesta: "aquí estoy, soy Ana, tu nieta". Esa y más frases que calman, en el post. Y su pulsera ComeHomeTag para el día que salga solo: comehometag.com
```
